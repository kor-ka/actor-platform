...
public final class PluginBundleManager {
     ...
     */
    public static Bundle generateBundle(final Context context, final long peer) {
        final Bundle result = new Bundle();
        result.putInt(BUNDLE_EXTRA_INT_VERSION_CODE, Constants.getVersionCode(context));

        result.putLong(FireReceiver.KEY_PEER, peer);
        result.putString(FireReceiver.KEY_TEXT, "%text");
        return result;
    }
